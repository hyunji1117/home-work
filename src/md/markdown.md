...
마크다운은 규칙을 기반으로 일반 텍스트를 구조화 된 문서로 작성하기 위한 **_마크업 언어_** 이다.
...
> 아래 줄 모두 수평선을 만든다. 마크다운 문서를 미리보기로 출력할 때 _페이지 나누기_ 용도로 많이 사용한다.
...
> 모든 환경에서 동일한 방식으로 동작하기 위해 이미지 경로는 **_절대경로_** 로 작성한다.
